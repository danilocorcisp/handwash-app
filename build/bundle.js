    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1taxq1z");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md\r\n    12@sm");
    			attr(div1, "class", "progress-container svelte-1taxq1z");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			t4 = text("Start");
    			attr(h2, "bp", "offset-5@md 4@md\r\n    12@sm");
    			attr(h2, "class", "svelte-13ofrch");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "bp", "offset-5@md 4@md\r\n    12@sm");
    			attr(button, "class", "start svelte-13ofrch");
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div.innerHTML = `<img bp="offset-5@md 4@md
    12@sm" src="handwashing.png" alt="How to wash your hands." class="svelte-wwxt9"/>`;
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int" class="svelte-p20hib">Picture Source</a> 
     <a href="https://freesound.org/people/metrostock99/sounds/345086/" class="svelte-p20hib">Sound Source</a>`;

    			t7 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<track kind="captions"/><source src="yeah.wav"/>`;
    			attr(h1, "class", "svelte-p20hib");
    			attr(h3, "class", "svelte-p20hib");
    		},
    		m(target, anchor) {
